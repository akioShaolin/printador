...
def capturar_paginas_auto(max_folhas=137):
    ...
    while cont_folhas < max_folhas:
        ...
        if area:
            x, y, w, h = area
            folha = screenshot.crop((x+18, y, x + w, y + h))

            nome_arquivo = f"folha_{cont_folhas + 1:03d}.png"
            folha.save(nome_arquivo)
            ...
            pyautogui.scroll(-1022)  # valor negativo = rolar para baixo
            time.sleep(1)
